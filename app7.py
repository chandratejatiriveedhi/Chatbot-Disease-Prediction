...
X_train_columns = [
    ...
    'Blood Pressure', 'Cholesterol Level', 'Age'  # Include all features used during training
]
...
def extract_features_from_text(user_input):
    ...
    feature_keywords = {
        ...
        "age": "Age"  # Include additional features here
    }
    ...
    extracted_features = {
        ...
        "Age": 0  # Default value for Age, update this based on user input
    }
